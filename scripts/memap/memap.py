...
# This program is part of the MBed 5 tools, but I ripped it out and put it inside mbed-cmake.
# I also patched it for CMake's Windows .obj file extensions
...
class _GccParser(_Parser):
    ...
    RE_OBJECT_FILE = re.compile(r'^(.+\/.+\.(o|obj))$')
    RE_LIBRARY_OBJECT = re.compile(r'^.*lib((.+a)\((.+(o|obj))\))$')
        ...
        if test_re:
            ...
            if test_re.group(4) == 'RO':
                ...
                if test_re.group(3) == 'Data':
                    ...
                    print("Malformed input found when parsing armcc map: %s, %r" % (line, test_re.groups()))
